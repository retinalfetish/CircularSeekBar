...
## Usage
The library is part of [JCenter](https://bintray.com/rogue/maven/com.unary:circularseekbar) (a default repository) and can be included in your project by adding `implementation 'com.unary:circularseekbar:1.1.0'` as a module dependency. The latest build can also be found at [JitPack](https://jitpack.io/#com.unary/circularseekbar).
```
allprojects {
    repositories {
        ...
